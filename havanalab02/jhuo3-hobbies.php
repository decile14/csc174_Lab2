<?php
$currentPage = "Jhou | Hobbies";
include "inc/html-top-j.inc";
?>

	<nav>
	<ul>
		<li><a href="jhuo3-main.php">Intro</a></li>
		<li><a href="jhuo3-hobbies.php" class = "is-current">hobbies</a></li>
		<li><a href="jhuo3-work.php">Work</a></li>
		<li><a href="jhuo3-earlydays.php">Early Days</a></li>
	</ul>
</nav>
	<main>
